...
const ModalEditarAfectacionParcela = ({
  modalEditar,
  ...
  const editarAfectacionParcela1 = async () => {
    await axios
      .put(
        `${URL}/editarAfectacionParcela/` + afectacionparcelaSeleccionado.id,
        afectacionparcelaSeleccionado, {
           headers: {
      ...
      .then((response) => {
        ...
        afectacionparcelaNuevo.map((afectacionparcela) => {
          if (afectacionparcela.id === afectacionparcelaSeleccionado.id) {
            ...
            afectacionparcela.idparcela =
              afectacionparcelaSeleccionado.idparcela;
            afectacionparcela.idafectacion =
              afectacionparcelaSeleccionado.idafectacion;
            afectacionparcela.fecha = afectacionparcelaSeleccionado.fecha;
            afectacionparcela.observacion =
              afectacionparcelaSeleccionado.observacion;
...
export default ModalEditarAfectacionParcela;
